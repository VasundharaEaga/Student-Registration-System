	...
	<div class="container">
            <div class="regbox box">
				...
				<form action="AddServlet" method="post">
                   ...
                   <p>CourseId</p>
				   <input type="text" placeholder="CourseID" name="cid" required>
                   <p>CourseName</p>
				   <input type="text" placeholder="Course Name" name="cname" required>
                   <p>Course Description</p>
				   <input type="text" placeholder="Description" name="desp" required>
				   <p>Course Fee</p>
				   <input type="text" placeholder="CourseFee" name="fee" required>
                   <input type="submit" value="Add" >
                   <a href="welcome_admin.jsp">Back to main Page</a>
                </form>
			</div>
	</div>
</body>
